...
const About = () => {
  ...
  return (
    <div  id="About" className={ `${styles.section} w-full flex md:flex-row flex-col-reverse md:p-20` }>
      {/* <div className="flex">
      ...
      {/* ------------ avatar ------------ */}
      <div className="relative md:w-1/3 md:h-[500px] flex md:flex-col md:mt-0 mt-4">
        <video
      ...
      {/* ------------ description ------------ */}
      <div className="md:w-2/3 md:p-20 text-center p-2">
        <h2 className="text-white md:text-4xl text-2xl font-bold my-4">{about.h1}</h2>
