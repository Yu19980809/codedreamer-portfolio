...
const Contact = () => {
  ...
  return (
    <section id="Contact" className={ `${styles.section} w-full` }>
      <div className="flex md:flex-row flex-col-reverse justify-between items-center w-full min-h-[600px] md:px-0 px-[30px] md:py-[40px] py-[20px] rounded-[16px] bg-work-gradient">
        {/* info part */}
